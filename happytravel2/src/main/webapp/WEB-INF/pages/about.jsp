...
<body>
    ...
    <div class="container">
        ...
        <h3>Our Story</h3>
        <p>Happy Travel was founded in [Year] with the vision of making travel dreams come true. Since then, we have grown into a reputable travel company, helping thousands of travelers discover new cultures, landscapes, and adventures.</p>
